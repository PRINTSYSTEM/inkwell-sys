  ...
  // ==== Phòng ban thiết kế ====
  {
    ...
    children: [
      ...
      },
      {
        ...
        allowedRoles: [ROLE.DESIGN, ROLE.DESIGN_LEAD, ROLE.SALE, ROLE.ADMIN, ROLE.MANAGER],
      },
    ],
  },
    ...
    children: [
      {
        ...
        icon: BarChart3,
        path: ROUTE_PATHS.PRODUCTION.DASHBOARD,
        allowedRoles: [
          ROLE.ADMIN,
          ROLE.MANAGER,
          ROLE.PRODUCTION,
      ...
      },
      {
        ...
        icon: Activity,
        path: ROUTE_PATHS.PRODUCTION.CAPACITY,
        allowedRoles: [
          ROLE.ADMIN,
          ROLE.MANAGER,
          ROLE.PRODUCTION,
      ...
      {
        id: "production-sla-config",
        title: "Thời gian sản xuất",
        icon: Settings,
        path: ROUTE_PATHS.PRODUCTION.SLA_CONFIG,
        allowedRoles: [
          ROLE.ADMIN,
          ROLE.MANAGER,
          ROLE.PRODUCTION_LEAD,
      ...
      {
        id: "production-print-orders",
        title: "Lệnh in",
        icon: Printer,
        path: ROUTE_PATHS.PRODUCTION.PRINT_ORDERS,
        allowedRoles: [
          ROLE.ADMIN,
          ROLE.MANAGER,
          ROLE.PRINTER,
      ...
      {
        id: "production-post-print",
        title: "Sản xuất sau in",
        icon: Scissors,
        path: ROUTE_PATHS.PRODUCTION.POST_PRINT,
        allowedRoles: [
          ROLE.ADMIN,
          ROLE.MANAGER,
          ROLE.PRODUCTION,
