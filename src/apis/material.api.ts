...
const materialTypeCategories = [...mockMaterialTypeCategories];
  ...
  static async getMaterials(params: MaterialSearchParams = { page: 1, pageSize: 10 }): Promise<PaginatedResponse<Material>> {
    ...
    if (params.sortBy) {
      filteredMaterials.sort((a, b) => {
        const aValue = a[params.sortBy! as keyof Material] as unknown;
        const bValue = b[params.sortBy! as keyof Material] as unknown;
