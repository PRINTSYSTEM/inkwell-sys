...
export const RELATED_QUERIES: Record<string, string[]> = {
  ...
  "proofing-orders": ["proofing-orders", "orders", "productions", "production-orders"],
  productions: ["productions", "production-orders", "proofing-orders", "orders"],
  "production-orders": ["production-orders", "productions", "proofing-orders", "orders"],
