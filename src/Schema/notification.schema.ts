...
export const NotificationActionSchema = z.object({
  ...
  style: z.enum(['primary', 'secondary', 'success', 'warning', 'danger']).default('primary')
});
...
export const NotificationPreferencesSchema = z.object({
  ...
  types: z.object({
    ...
    assignment: z.object({
      enabled: z.boolean().default(true),
      channels: z.array(NotificationChannelEnum).default(['in_app', 'email', 'push'])
    }),
...
export const NotificationFilterSchema = z.object({
  ...
  sortBy: z.enum(['createdAt', 'priority', 'title', 'status']).default('createdAt'),
