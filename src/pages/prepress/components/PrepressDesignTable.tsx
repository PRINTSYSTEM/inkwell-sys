      ...
      <div className="shrink-0 border-b p-4 flex flex-col gap-3">
          ...
          {materialTypeOptions && setSelectedMaterialTypes && (
            <div className="w-44">
              <select
                ...
                value={
                  selectedMaterialTypes && selectedMaterialTypes.length === 1
                    ? String(selectedMaterialTypes[0])
                    : ""
                }
                onChange={(e) => {
        ...
        {designTypeOptions && setSelectedDesignTypes && (
          <div className="flex items-center gap-2 overflow-x-auto pt-2">
            <button
              className={`text-xs px-2 py-1 rounded-full ${!selectedDesignTypes || selectedDesignTypes.length === 0 ? "bg-primary/10 text-primary font-semibold" : "bg-muted/10 text-muted-foreground"}`}
              ...
              return (
                <button
                  ...
                  onClick={() => {
                    ...
                    if (active)
                      setSelectedDesignTypes(
                        selectedDesignTypes.filter((id) => id !== dt.id),
                      );
                    else
                      setSelectedDesignTypes([...selectedDesignTypes, dt.id]);
                  }}
              ...
              <Table className="min-w-[980px] table-fixed">
                <TableHeader className="bg-muted/20">
                  <TableRow className="h-16">
                    <TableHead className="text-sm font-bold w-20">
                      Ảnh
                    </TableHead>
                    <TableHead className="text-sm font-bold w-36">
                      Mã hàng
                    </TableHead>
                    <TableHead className="text-sm font-bold w-24">
                      Số lượng
                    </TableHead>
                    <TableHead className="text-sm font-bold w-36">
                      Quy cách
                    </TableHead>
                    <TableHead className="text-sm font-bold w-48">
                      Chất liệu
                    </TableHead>
                    <TableHead className="text-sm font-bold w-24">
                      Loại
                    </TableHead>
                    <TableHead className="w-12 text-right text-sm font-bold sticky right-0 bg-muted/20 z-20">
                      Thao tác
                    </TableHead>
                  </TableRow>
                </TableHeader>
