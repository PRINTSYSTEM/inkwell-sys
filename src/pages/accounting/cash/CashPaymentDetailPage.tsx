...
export default function CashPaymentDetailPage() {
  ...
  const isPosted = payment?.status?.toLowerCase() === "posted";
  ...
  const startEditingCard = (cardName: string) => {
    ...
    setCardEditValues({
      voucherDate: payment.voucherDate || null,
  ...
  const handleDelete = () => {
    ...
    deleteMutation.mutate(payment.id, {
      onSuccess: () => {
        navigate("/accounting/cash-payments");
      },
    });
  };
    ...
    <>
      ...
      <div className="container mx-auto py-6 space-y-6">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <div className="font-mono text-sm">{payment.code || "—"}</div>
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                {editingCard === "main" ? (
                  <Input
                    value={(cardEditValues.receiverName as string) || ""}
                    onChange={(e) =>
                      setCardEditValues({
                        ...cardEditValues,
                        receiverName: e.target.value,
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <div className="text-sm">{payment.vendorName || "—"}</div>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <div className="text-sm">{payment.createdByName || "—"}</div>
              ...
              {payment.approvedById && (
                <div className="space-y-2">
                  ...
                  <div className="text-sm">{payment.approvedByName || "—"}</div>
                  <div className="text-xs text-muted-foreground">
              ...
              {payment.postedById && (
                <div className="space-y-2">
                  ...
                  <div className="text-sm">{payment.postedByName || "—"}</div>
                  <div className="text-xs text-muted-foreground">
        ...
        <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
          <DialogContent>
            <DialogHeader>
              <DialogTitle>Xác nhận xóa phiếu chi</DialogTitle>
              <DialogDescription>
                Bạn có chắc chắn muốn xóa phiếu chi {payment.code}? Hành động
