...
import {
  useCreateDebtReconciliationAP,
  useDownloadDebtReconciliationAP,
} from "@/hooks/use-ar-ap";
import { formatCurrency } from "@/lib/status-utils";
import { DebtReconciliationAPModal } from "@/components/accounting/debt-reconciliations/DebtReconciliationAPModal";
...
export default function DebtReconciliationAPPage() {
      ...
      <div className="flex-shrink-0 px-6 py-3 border-b bg-background flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Tạo và tải xuống biên bản đối chiếu công nợ với nhà cung cấp
          </p>
        </div>
          ...
          <div className="flex-1 flex items-center justify-center">
            <Card className="w-full max-w-md">
              ...
              <CardContent className="text-center text-muted-foreground">
                <p className="mb-4">
                  Tạo biên bản đối chiếu công nợ phải trả với nhà cung cấp
                </p>
                <Button onClick={() => setIsCreateModalOpen(true)}>
                  <Plus className="h-4 w-4 mr-2" />
