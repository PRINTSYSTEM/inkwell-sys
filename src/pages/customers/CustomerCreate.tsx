...
export default function CreateCustomer() {
  ...
  const [form, setForm] = useState<CreateCustomerForm>({
    ...
    phone: '',
    address: '',
    type: 'company', // Mặc định là công ty
  ...
  // Tạo mã khách hàng preview (simplified version - real generation happens on server)
      ...
      if (error instanceof ZodError) {
        error.errors.forEach((err) => {
          ...
          if (fieldPath === 'name' || fieldPath === 'representativeName') {
            ...
            newErrors.maxDebt = 'Hạn mức công nợ không hợp lệ';
          } else if (fieldPath === 'currentDebt') {
            newErrors.currentDebt = 'Công nợ hiện tại không hợp lệ';
          }
        });
      }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(error instanceof Error ? error.message : 'Lỗi không xác định khi tạo khách hàng');
    } finally {
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="VD: Nguyễn Minh Phúc (tên gọi chung)"
                    ...
                    <p className="text-xs text-muted-foreground">
                      Tên gọi chung của khách hàng (có thể giống tên đại diện hoặc tên công ty)
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Mã khách hàng sẽ được tự động tạo bởi hệ thống khi lưu
                    </p>
                  </div>
            ...
            <Alert>
              ...
              <AlertDescription className="text-sm">
                ...
                <ul className="mt-2 space-y-1 list-disc list-inside">
                  ...
                  <li>Tên viết tắt lấy 2 chữ cái đầu của 2 từ cuối (VD: Nguyễn Minh Phúc → MP)</li>
