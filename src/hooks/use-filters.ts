...
export function useFilters(
  ...
  const [state, setState] = useState<FilterState>(() => {
    ...
    return {
      ...
      activeFiltersCount: Object.keys(persisted?.filters || initialFilters)
        .length,
    };
  });
  ...
  const searchInFields = useCallback(
    <T>(
      item: T,
      query: string,
      searchFields: (keyof T)[],
  ...
  const actions: FilterActions = useMemo(
    () => ({
      ...
      applyFilters: <T>(data: T[], options: FilterOptions<T> = {}) => {
        const {
          searchFields = [],
          customFilters = {} as FilterOptions<T>["customFilters"],
          caseSensitive = false,
        } = options;
...
export const filterHelpers = {
  ...
  contains: (value: string): FilterValue => ({
    value,
    operator: "contains",
    type: "string",
  }),
  startsWith: (value: string): FilterValue => ({
    value,
    operator: "startsWith",
    type: "string",
  }),
  endsWith: (value: string): FilterValue => ({
    value,
    operator: "endsWith",
    type: "string",
  }),
  ...
  greaterThanOrEqual: (value: number): FilterValue => ({
    value,
    operator: "gte",
    type: "number",
  }),
  ...
  lessThanOrEqual: (value: number): FilterValue => ({
    value,
    operator: "lte",
    type: "number",
  }),
  inArray: (values: unknown[]): FilterValue => ({
    value: values,
    operator: "in",
    type: "array",
  }),
  notInArray: (values: unknown[]): FilterValue => ({
    value: values,
    operator: "nin",
    type: "array",
  }),
  dateAfter: (date: Date): FilterValue => ({
    value: date,
    operator: "gt",
    type: "date",
  }),
  dateBefore: (date: Date): FilterValue => ({
    value: date,
    operator: "lt",
    type: "date",
  }),
