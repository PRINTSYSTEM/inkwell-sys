...
const productCategoryData = [
  ...
  { category: "Chất liệu", sales: 167000, quantity: 445 },
];
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <HorizontalBarChart
        ...
        data={departmentData}
        xAxisKey="department"
        yAxisKeys={[{ key: "budget", name: "Ngân sách", color: "#f59e0b" }]}
        valueType="currency"
        config={{ height: 300 }}
      />
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Demonstration của các chart components tái sử dụng với Recharts và
            TypeScript
          </p>
        </div>
        ...
        <TabsContent value="line" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Biểu đồ đường với nhiều biến thể: simple, multi-line, time
                series
              </CardDescription>
            </CardHeader>
            <CardContent>
