  ...
  useEffect(() => {
    if (open && order) {
      ...
      setFormData({
        ...
        customerTaxCode: (order.customer && "taxCode" in order.customer && typeof (order.customer as { taxCode?: string }).taxCode === "string") ? (order.customer as { taxCode: string }).taxCode : null,
