            ...
            {designs.map((design) => {
                ...
                <div className="space-y-2 text-sm max-w-md">
                  ...
                  <div className="grid grid-cols-2 gap-x-4 gap-y-1.5">
                    ...
                    <div>
                      ...
                      <span className="ml-2 font-semibold">{design.orderCode || design.orderId}</span>
                    </div>
                    ...
                    <div>
                      ...
                      <span className={`ml-2 font-semibold ${
                        design.availableQuantity && design.availableQuantity > 0
                          ? "text-green-600"
                          : "text-red-600"
                      }`}>
                  ...
                  {(design.processClassificationOptionName ||
                    ...
                    <div className="pt-2 border-t space-y-1">
                      {design.processClassificationOptionName && (
                        <div>
                          <span className="text-muted-foreground">Cắt - Bế:</span>
                          <span className="ml-2">
                            {processClassificationLabels[design.processClassificationOptionName] ||
                              design.processClassificationOptionName}
                          </span>
                        </div>
                      )}
                      {design.sidesClassification && (
                        <div>
                          <span className="text-muted-foreground">1 - 2 mặt:</span>
                          <span className="ml-2">
                            {sidesClassificationLabels[design.sidesClassification] ||
                              design.sidesClassification}
                          </span>
                        </div>
                      )}
              ...
              return (
                ...
                >
                  ...
                  <TableCell>
                    <TruncatedText text={design.name} className="font-medium" />
                  </TableCell>
                  <TableCell>
