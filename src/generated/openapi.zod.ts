...
const CustomerDebtSummaryResponse = z
  ...
  .partial();
const DebtStatementItemResponse = z
  .object({
    id: z.number().int(),
    date: z.string().datetime({ offset: true }),
    deliveryNoteCode: z.string().nullable(),
    invoiceDate: z.string().datetime({ offset: true }).nullable(),
  ...
  .partial();
const CustomerDebtStatementResponse = z
  .object({
    customerId: z.number().int(),
    customerName: z.string().nullable(),
    month: z.number().int(),
    ...
    items: z.array(DebtStatementItemResponse).nullable(),
  })
  .partial();
const CustomerDebtStatementByRangeResponse = z
  .object({
    customerId: z.number().int(),
    customerName: z.string().nullable(),
...
const APAgingResponseIPaginate = z
  ...
  .partial();
const APReconciliationRow = z
  .object({
    date: z.string().datetime({ offset: true }),
    documentNumber: z.string().nullable(),
    documentType: z.string().nullable(),
    description: z.string().nullable(),
    spec1: z.string().nullable(),
    spec2: z.string().nullable(),
    spec3: z.string().nullable(),
  ...
  .partial();
const APReconciliationResponse = z
  .object({
    vendorName: z.string().nullable(),
    ...
    totalCredit: z.number(),
    closingBalance: z.number(),
    supplierTypeCode: z.string().nullable(),
    specHeaders: z.array(z.string()).nullable(),
    rows: z.array(APReconciliationRow).nullable(),
  })
  .partial();
...
const DeliveryNoteResponsePaginate = z
  ...
  .partial();
const CreateDeliveryFromInventoryRequest = z.object({
  customerId: z.number().int(),
  designId: z.number().int(),
...
const UpdateDesignCodeRequest = z
...
const SetOpeningBalanceRequest = z.object({
  itemCode: z.string().min(1),
  itemType: z.string().min(1),
  quantity: z.number().int(),
  effectiveDate: z.string().datetime({ offset: true }),
});
const DeleteOpeningBalanceRequest = z.object({
  itemCode: z.string().min(1),
  itemType: z.string().min(1),
});
...
const InventoryTransactionResponse = z
  .object({
    ...
    quantity: z.number().int(),
    stockInQuantity: z.number().int(),
    stockOutQuantity: z.number().int(),
    wasteQuantity: z.number().int(),
...
const UpdateInvoiceRequest = z
  ...
  .partial();
const InvoiceSummaryStatsResponse = z
  .object({
    pendingInvoiceCount: z.number().int(),
    issuedTodayCount: z.number().int(),
  })
  .partial();
...
const CreateInvoiceFromLinesRequest = z.object({
  ...
  billToCustomerId: z.number().int().nullish(),
  invoiceNumber: z.string().min(0).max(50).nullish(),
  discountPercent: z.number().gte(0).lte(100).nullish(),
...
const MaterialResponse = z
  .object({
    ...
    materialFamilyId: z.number().int().nullable(),
    materialFamilyName: z.string().nullable(),
    materialFamilyCode: z.string().nullable(),
    materialTypeId: z.number().int().nullable(),
    materialTypeName: z.string().nullable(),
...
const MaterialSpecResponsePaginate = z
  .object({
    size: z.number().int(),
    page: z.number().int(),
    total: z.number().int(),
...
const OrderExportResponse = z
  ...
  .partial();
const OutsourceOrderResponse = z
  .object({
    id: z.number().int(),
    proofingOrderId: z.number().int(),
    proofingOrderCode: z.string().nullable(),
    ...
    completedAt: z.string().datetime({ offset: true }).nullable(),
    isReceived: z.boolean(),
    accountingConfirmedAt: z.string().datetime({ offset: true }).nullable(),
    notes: z.string().nullable(),
    createdBy: UserInfo,
    createdAt: z.string().datetime({ offset: true }),
    amountPaid: z.number(),
  ...
  .partial();
const OutsourceOrderResponsePaginate = z
  .object({
    size: z.number().int(),
    page: z.number().int(),
    total: z.number().int(),
    totalPages: z.number().int(),
    items: z.array(OutsourceOrderResponse).nullable(),
  })
  .partial();
const UpdateOutsourceOrderRequest = z
  .object({
...
const ProductionOrderResponse = z
  ...
  .partial();
const ProductionOrderItemListResponse = z
  .object({
    id: z.number().int(),
    designId: z.number().int(),
    designCode: z.string().nullable(),
  ...
  .partial();
const ProductionStepListResponse = z
  .object({
    id: z.number().int(),
    stepType: z.string().nullable(),
    stepTypeName: z.string().nullable(),
...
const DesignExpandResponse = z
  ...
  .partial();
const ProofingOrderDesignExpandResponse = z
  .object({
    isUrgent: z.boolean(),
    design: DesignExpandResponse,
    quantity: z.number().int(),
    itemsPerSheet: z.number().int(),
    designImageUrl: z.string().nullable(),
    designThumbnailUrl: z.string().nullable(),
  })
  .partial();
const DieSimpleResponse = z
  .object({
    id: z.number().int(),
    code: z.string().nullable(),
    size: z.string().nullable(),
  ...
  .partial();
const DieExportExpandResponse = z
  .object({
    id: z.number().int(),
    code: z.string().nullable(),
    size: z.string().nullable(),
    ...
    estimatedReceiveAt: z.string().datetime({ offset: true }).nullable(),
    notes: z.string().nullable(),
    die: DieSimpleResponse,
  })
  .partial();
const PlateExportExpandResponse = z
  .object({
    id: z.number().int(),
    plateCount: z.number().int(),
    productionMethod: z.string().nullable(),
  ...
  .partial();
const ProofingOrderExpandResponse = z
  .object({
    id: z.number().int(),
    code: z.string().nullable(),
    isUrgent: z.boolean(),
    ...
    proofingOrderDesigns: z.array(ProofingOrderDesignExpandResponse).nullable(),
    proofingOrderDies: z.array(DieExportExpandResponse).nullable(),
    plateExport: PlateExportExpandResponse,
  })
  .partial();
const ProductionOrderListResponse = z
  .object({
    id: z.number().int(),
    proofingOrderId: z.number().int(),
    proofingOrderCode: z.string().nullable(),
    ...
    hasDeliveryNote: z.boolean(),
    proofingOrderImages: z.array(ProofingOrderImageResponse).nullable(),
    items: z.array(ProductionOrderItemListResponse).nullable(),
    steps: z.array(ProductionStepListResponse).nullable(),
    proofingOrder: ProofingOrderExpandResponse,
  })
  .partial();
const ProductionOrderListResponsePaginate = z
  .object({
    size: z.number().int(),
    page: z.number().int(),
    total: z.number().int(),
    totalPages: z.number().int(),
    items: z.array(ProductionOrderListResponse).nullable(),
  })
  .partial();
const ProductionOrderSummaryStatsResponse = z
  .object({
    pendingMaterial: z.number().int(),
    inProduction: z.number().int(),
    inProductionToday: z.number().int(),
    pendingQc: z.number().int(),
...
const KcsItemResponse = z
  .object({
    productionOrderItemId: z.number().int(),
    designId: z.number().int(),
    designCode: z.string().nullable(),
    designName: z.string().nullable(),
    designImageUrl: z.string().nullable(),
  ...
  .partial();
const KcsDefectRecordResponse = z
  .object({
    id: z.number().int(),
    designId: z.number().int(),
    orderDetailId: z.number().int().nullable(),
  ...
  .partial();
const KcsProductionOrderResponse = z
  .object({
    productionOrderId: z.number().int(),
    status: z.string().nullable(),
    proofingOrderId: z.number().int(),
    proofingOrderCode: z.string().nullable(),
    proofingOrderCompletedAt: z.string().datetime({ offset: true }).nullable(),
    designTypeId: z.number().int().nullable(),
    designTypeName: z.string().nullable(),
    designTypeCode: z.string().nullable(),
    proofingOrderImages: z.array(ProofingOrderImageResponse).nullable(),
    items: z.array(KcsItemResponse).nullable(),
    defectRecords: z.array(KcsDefectRecordResponse).nullable(),
  })
  .partial();
const KcsProductionOrderResponsePaginate = z
  .object({
    size: z.number().int(),
    page: z.number().int(),
    total: z.number().int(),
    totalPages: z.number().int(),
    items: z.array(KcsProductionOrderResponse).nullable(),
  })
  .partial();
const KcsDesignTypeCountResponse = z
  .object({
    designTypeId: z.number().int(),
    designTypeName: z.string().nullable(),
    designTypeCode: z.string().nullable(),
    productionOrderCount: z.number().int(),
    totalItemCount: z.number().int(),
  })
  .partial();
const KcsLabelPrintResponse = z
  .object({
    customerName: z.string().nullable(),
    customerCode: z.string().nullable(),
    customerCompanyName: z.string().nullable(),
...
const ProofingOrderResponse = z
  .object({
    ...
    isHiddenFromDelivery: z.boolean(),
    ...
    updatedAt: z.string().datetime({ offset: true }),
    completedAt: z.string().datetime({ offset: true }).nullable(),
    scheduleStatus: z.string().nullable(),
...
const AddProofingOrderDetailItem = z.object({
  ...
  quantity: z.number().int().gte(1).lte(2147483647),
  itemsPerSheet: z.number().int().gte(1).lte(2147483647).nullish(),
});
const AddDesignsToProofingOrderRequest = z.object({
  materialTypeId: z.number().int().nullish(),
  items: z.array(AddProofingOrderDetailItem),
});
const AddDesignsToProofingOrderResponse = z
  .object({
    proofingOrder: ProofingOrderResponse,
    errorMessages: z.array(z.string()).nullable(),
  })
  .partial();
...
const UpdateScheduleStatusRequest = z.object({
  scheduleStatus: z.string().min(1),
});
const UpdateDeliveryVisibilityRequest = z.object({
  isHiddenFromDelivery: z.boolean(),
});
...
const UpdateAvailableQuantityRequest = z.object({
  newAvailableQuantity: z.number().int().gte(0).lte(2147483647),
});
const UpdateAvailableQuantityResponse = z
  .object({
    designId: z.number().int(),
    readyDesignId: z.number().int().nullable(),
    orderDetailId: z.number().int().nullable(),
    oldAvailableQuantity: z.number().int(),
    newAvailableQuantity: z.number().int(),
    delta: z.number().int(),
...
const AuxiliaryStockInItemRequest = z.object({
  materialTypeId: z.number().int(),
  name: z.string().min(1),
  quantity: z.number().int().gte(1).lte(2147483647),
  unit: z.string().nullish(),
...
const CreateAuxiliaryStockInRequest = z.object({
  vendorId: z.number().int(),
  stockInDate: z.string().datetime({ offset: true }).nullish(),
  notes: z.string().nullish(),
  items: z.array(AuxiliaryStockInItemRequest).min(1),
});
...
const UpdateStockInRequest = z
  ...
  .partial();
const DirectIssueItem = z.object({
  materialId: z.number().int(),
  quantity: z.number().int().gte(1).lte(2147483647),
  unitPrice: z.number().nullish(),
});
const DirectMaterialIssueRequest = z.object({
  vendorId: z.number().int(),
  productionOrderCode: z.string().min(1),
  items: z.array(DirectIssueItem).min(1),
  notes: z.string().nullish(),
});
const UpdateStockInPriceItem = z.object({
  stockInItemId: z.number().int(),
  unitPrice: z.number().gte(0),
  lineAmount: z.number().nullish(),
});
const UpdateStockInPricesRequest = z.object({
  stockInId: z.number().int(),
  stockInDate: z.string().datetime({ offset: true }).nullish(),
  items: z.array(UpdateStockInPriceItem),
});
const StockInItemResponse = z
  .object({
    id: z.number().int(),
    lineKind: z.string().nullable(),
    itemName: z.string().nullable(),
    itemCode: z.string().nullable(),
    unit: z.string().nullable(),
    quantity: z.number().int(),
    ...
    width: z.number().nullable(),
    height: z.number().nullable(),
    ramQuantity: z.number().nullable(),
    ramAmount: z.number().nullable(),
    proofingOrderId: z.number().int().nullable(),
    proofingOrderCode: z.string().nullable(),
    jobCode: z.string().nullable(),
    isPricePending: z.boolean(),
  })
  .partial();
const StockInResponse = z
  .object({
    id: z.number().int(),
    code: z.string().nullable(),
    source: z.string().nullable(),
    ...
    deliveryNoteId: z.number().int().nullable(),
    deliveryNoteCode: z.string().nullable(),
    originalStockOutId: z.number().int().nullable(),
    originalStockOutCode: z.string().nullable(),
    orderId: z.number().int().nullable(),
    orderCode: z.string().nullable(),
    totalAmount: z.number(),
    laborCost: z.number(),
    ...
    createdAt: z.string().datetime({ offset: true }),
    updatedAt: z.string().datetime({ offset: true }).nullable(),
    items: z.array(StockInItemResponse).nullable(),
    totalQuantity: z.number().int(),
  })
  .partial();
const StockOutItemRequest = z.object({
  ...
  materialId: z.number().int().nullish(),
  orderDetailId: z.number().int().nullish(),
  cutLength: z.number().nullish(),
  cutWidth: z.number().nullish(),
  quantityProduced: z.number().int().nullish(),
});
...
const CreateStockOutForProductionOrderRequest = z.object({
  receiverName: z.string().min(1),
  notes: z.string().nullish(),
  stockOutDate: z.string().datetime({ offset: true }).nullish(),
  items: z.array(ProductionStockOutItemRequest).min(1),
...
const UpdateStockOutRequest = z
  ...
  .partial();
const WasteUpdateItem = z.object({
  stockOutItemId: z.number().int(),
  wasteQuantity: z.number().int().gte(0).lte(2147483647),
});
const CompleteStockOutRequest = z
  .object({ wasteUpdates: z.array(WasteUpdateItem).nullable() })
  .partial();
...
const CreateUserRequest = z.object({
  ...
  role: z
    ...
    .min(1)
    .regex(
      /^(admin|manager|design|design_lead|proofer|production|production_lead|kcs|accounting|accounting_lead|warehouse|warehouse_lead|hr|hr_lead|cskh|cskh_lead|sale)$/,
    ),
  email: z.string().min(0).max(255).email().nullish(),
  phone: z.string().min(0).max(20).nullish(),
});
...
const UpdateUserRequest = z
  .object({
    ...
    role: z
      .string()
      .regex(
        /^(admin|manager|design|design_lead|proofer|production|production_lead|kcs|accounting|accounting_lead|warehouse|warehouse_lead|hr|hr_lead|cskh|cskh_lead)$/,
      )
      .nullable(),
    email: z.string().min(0).max(255).email().nullable(),
    phone: z.string().min(0).max(20).nullable(),
...
const VendorDebtHistoryResponse = z
  .object({
    id: z.number().int(),
    createdAt: z.string().datetime({ offset: true }),
    previousDebt: z.number(),
    ...
    note: z.string().nullable(),
    stockInId: z.number().int().nullable(),
    stockInCode: z.string().nullable(),
    cashPaymentId: z.number().int().nullable(),
    cashPaymentCode: z.string().nullable(),
    createdById: z.number().int(),
    createdByName: z.string().nullable(),
  })
  .partial();
...
export const schemas = {
  ...
  OutsourceOrderResponsePaginate,
  ...
  ProductionOrderItemListResponse,
  ProductionStepListResponse,
  DesignExpandResponse,
  ProofingOrderDesignExpandResponse,
  DieSimpleResponse,
  DieExportExpandResponse,
  PlateExportExpandResponse,
  ProofingOrderExpandResponse,
  ProductionOrderListResponse,
  ProductionOrderListResponsePaginate,
  ProductionOrderSummaryStatsResponse,
  ...
  KcsItemResponse,
  KcsDefectRecordResponse,
  KcsProductionOrderResponse,
  KcsProductionOrderResponsePaginate,
  KcsDesignTypeCountResponse,
  KcsLabelPrintResponse,
  ...
  UpdateAvailableQuantityResponse,
  ...
  DirectIssueItem,
  DirectMaterialIssueRequest,
  UpdateStockInPriceItem,
  UpdateStockInPricesRequest,
  StockInItemResponse,
  StockInResponse,
  StockOutItemRequest,
  ...
  CreateStockOutForProductionOrderRequest,
...
const endpoints = makeApi([
  ...
  {
    method: "get",
    path: "/api/customers/:id/debt-statement",
    alias: "getApicustomersIddebtStatement",
    requestFormat: "json",
    parameters: [
      {
        name: "id",
    ...
    response: CustomerDebtStatementResponse,
  },
  {
    method: "get",
    path: "/api/customers/:id/debt-statement-by-range",
    alias: "getApicustomersIddebtStatementByRange",
    requestFormat: "json",
    parameters: [
      {
        name: "id",
    ...
    response: CustomerDebtStatementByRangeResponse,
  },
  {
    method: "get",
  ...
  {
    method: "get",
    path: "/api/debt-reports/ap-reconciliation/:vendorId",
    alias: "getApidebtReportsapReconciliationVendorId",
    requestFormat: "json",
    parameters: [
      {
        name: "vendorId",
    ...
    response: APReconciliationResponse,
  },
  {
    method: "get",
    path: "/api/debt-reports/ap-reconciliation/:vendorId/export",
    alias: "getApidebtReportsapReconciliationVendorIdexport",
    requestFormat: "json",
    parameters: [
      {
        name: "vendorId",
  ...
  },
  {
    method: "delete",
    path: "/api/delivery-notes/:id",
    alias: "deleteApideliveryNotesId",
    requestFormat: "json",
    parameters: [
      {
        name: "id",
  ...
  {
    method: "post",
    path: "/api/delivery-notes/from-inventory",
    alias: "postApideliveryNotesfromInventory",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: CreateDeliveryFromInventoryRequest,
      },
    ],
    response: DeliveryNoteResponse,
  },
  ...
  {
    method: "post",
    path: "/api/designs/:id/cancel-from-pool",
    alias: "postApidesignsIdcancelFromPool",
    requestFormat: "json",
    parameters: [
      {
        name: "id",
  ...
  {
    method: "put",
    path: "/api/designs/:id/code",
    alias: "putApidesignsIdcode",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: z.object({ code: z.string().nullable() }).partial(),
      },
      {
        name: "id",
        type: "Path",
  ...
  {
    method: "post",
    path: "/api/designs/:id/mark-urgent",
    alias: "postApidesignsIdmarkUrgent",
    requestFormat: "json",
    parameters: [
      {
        name: "id",
  ...
  {
    method: "post",
    path: "/api/inventory/opening-balance",
    alias: "postApiinventoryopeningBalance",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: SetOpeningBalanceRequest,
      },
    ],
    response: z.void(),
    errors: [
  ...
  },
  {
    method: "delete",
    path: "/api/inventory/opening-balance",
    alias: "deleteApiinventoryopeningBalance",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: DeleteOpeningBalanceRequest,
      },
    ],
    response: z.void(),
    errors: [
  ...
  {
    method: "get",
    path: "/api/invoices/summary-stats",
    alias: "getApiinvoicessummaryStats",
    requestFormat: "json",
    response: InvoiceSummaryStatsResponse,
  },
  {
    method: "post",
  ...
  {
    method: "get",
    path: "/api/material-types/:materialTypeId/specs",
    alias: "getApimaterialTypesMaterialTypeIdspecs",
    requestFormat: "json",
    parameters: [
      {
        name: "materialTypeId",
  ...
  },
  {
    method: "post",
    path: "/api/material-types/:materialTypeId/specs",
    alias: "postApimaterialTypesMaterialTypeIdspecs",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
  ...
  {
    method: "get",
    path: "/api/material-types/:materialTypeId/specs/:id",
    alias: "getApimaterialTypesMaterialTypeIdspecsId",
    requestFormat: "json",
    parameters: [
      {
        name: "materialTypeId",
  ...
  },
  {
    method: "put",
    path: "/api/material-types/:materialTypeId/specs/:id",
    alias: "putApimaterialTypesMaterialTypeIdspecsId",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
  ...
  },
  {
    method: "delete",
    path: "/api/material-types/:materialTypeId/specs/:id",
    alias: "deleteApimaterialTypesMaterialTypeIdspecsId",
    requestFormat: "json",
    parameters: [
      {
        name: "materialTypeId",
  ...
  {
    method: "get",
    path: "/api/material-types/:materialTypeId/specs/paginated",
    alias: "getApimaterialTypesMaterialTypeIdspecspaginated",
    requestFormat: "json",
    parameters: [
      {
        name: "materialTypeId",
    ...
    response: MaterialSpecResponsePaginate,
  },
  {
    method: "get",
    path: "/api/materials",
  ...
  },
  {
    ...
    response: OutsourceOrderResponsePaginate,
  },
  {
    method: "get",
    path: "/api/outsource-orders/:id",
    alias: "getApioutsourceOrdersId",
    requestFormat: "json",
    parameters: [
      {
        name: "id",
    ...
    response: OutsourceOrderResponse,
  },
  {
    method: "put",
    path: "/api/outsource-orders/:id",
    alias: "putApioutsourceOrdersId",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: UpdateOutsourceOrderRequest,
      },
      {
        name: "id",
        type: "Path",
  ...
  },
  {
    ...
    response: ProductionOrderListResponsePaginate,
  },
  {
    method: "get",
  ...
  {
    method: "get",
    path: "/api/production-orders/:productionOrderId/items/:itemId/print-label",
    alias: "getApiproductionOrdersProductionOrderIditemsItemIdprintLabel",
    requestFormat: "json",
    parameters: [
      {
        name: "productionOrderId",
    ...
    response: KcsLabelPrintResponse,
  },
  {
    method: "put",
  ...
  {
    method: "get",
    path: "/api/production-orders/kcs",
    alias: "getApiproductionOrderskcs",
    requestFormat: "json",
    parameters: [
      {
        name: "pageNumber",
      ...
      {
        name: "proofingCompletedFromDate",
        type: "Query",
        schema: z.string().datetime({ offset: true }).optional(),
      },
      {
        name: "proofingCompletedToDate",
        type: "Query",
        schema: z.string().datetime({ offset: true }).optional(),
      },
      {
    ...
    response: KcsProductionOrderResponsePaginate,
  },
  {
    method: "get",
    path: "/api/production-orders/kcs/design-type-summary",
    alias: "getApiproductionOrderskcsdesignTypeSummary",
    requestFormat: "json",
    parameters: [
      {
        name: "proofingCompletedFromDate",
    ...
    response: z.array(KcsDesignTypeCountResponse),
  },
  {
    method: "get",
  ...
  {
    method: "get",
    path: "/api/production-orders/summary-stats",
    alias: "getApiproductionOrderssummaryStats",
    requestFormat: "json",
    parameters: [
      {
        name: "fromDate",
    ...
    response: ProductionOrderSummaryStatsResponse,
  },
  {
    method: "post",
  ...
  },
  {
    ...
    alias: "deleteApiproofingOrdersId",
    requestFormat: "json",
    parameters: [
      {
        name: "id",
  ...
  {
    method: "put",
    path: "/api/proofing-orders/:id/delivery-visibility",
    alias: "putApiproofingOrdersIddeliveryVisibility",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: z.object({ isHiddenFromDelivery: z.boolean() }),
      },
      {
        name: "id",
        type: "Path",
  ...
  },
  {
    ...
    response: AddDesignsToProofingOrderResponse,
  },
  {
    method: "post",
  ...
  {
    method: "put",
    path: "/api/proofing-orders/:id/schedule-status",
    alias: "putApiproofingOrdersIdscheduleStatus",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: z.object({ scheduleStatus: z.string().min(1) }),
      },
      {
        name: "id",
        type: "Path",
  ...
  {
    method: "get",
    path: "/api/proofing-orders/available-bins",
    alias: "getApiproofingOrdersavailableBins",
    requestFormat: "json",
    parameters: [
      {
        name: "designTypeId",
    ...
    response: z.array(ProofingOrderListResponse),
  },
  {
    method: "get",
  ...
  {
    method: "get",
    path: "/api/proofing-orders/completed",
    alias: "getApiproofingOrderscompleted",
    requestFormat: "json",
    parameters: [
      {
        name: "pageNumber",
  ...
  {
    method: "patch",
    path: "/api/proofing-orders/designs/:designId/available-quantity",
    alias: "patchApiproofingOrdersdesignsDesignIdavailableQuantity",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
    ...
    response: UpdateAvailableQuantityResponse,
    errors: [
      {
        status: 400,
        description: `Bad Request`,
  ...
  {
    method: "put",
    path: "/api/proofing-orders/dies/:dieExportId/receive",
    alias: "putApiproofingOrdersdiesDieExportIdreceive",
    requestFormat: "json",
    parameters: [
      {
        name: "dieExportId",
  ...
  {
    method: "put",
    path: "/api/proofing-orders/plates/:plateExportId/receive",
    alias: "putApiproofingOrdersplatesPlateExportIdreceive",
    requestFormat: "json",
    parameters: [
      {
        name: "plateExportId",
  ...
  {
    method: "put",
    path: "/api/stock-ins/:id/update-prices",
    alias: "putApistockInsIdupdatePrices",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: UpdateStockInPricesRequest,
      },
      {
        name: "id",
        type: "Path",
  ...
  {
    method: "post",
    path: "/api/stock-ins/auxiliary",
    alias: "postApistockInsauxiliary",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: CreateAuxiliaryStockInRequest,
      },
    ],
    response: z.void(),
  },
  ...
  {
    method: "post",
    path: "/api/stock-ins/direct-issue",
    alias: "postApistockInsdirectIssue",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: DirectMaterialIssueRequest,
      },
    ],
    response: z.void(),
  },
    ...
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: CompleteStockOutRequest,
      },
      {
        name: "id",
        type: "Path",
  ...
  {
    method: "get",
    path: "/api/stock-outs/by-vendor/:vendorId/excel",
    alias: "getApistockOutsbyVendorVendorIdexcel",
    requestFormat: "json",
    parameters: [
      {
        name: "vendorId",
  ...
  {
    method: "post",
    path: "/api/stock-outs/production-order/:productionOrderId",
    alias: "postApistockOutsproductionOrderProductionOrderId",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: CreateStockOutForProductionOrderRequest,
      },
      {
        name: "productionOrderId",
        type: "Path",
  ...
  {
    method: "post",
    path: "/api/vendors/:id/debt/settle",
    alias: "postApivendorsIddebtsettle",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: SettleVendorDebtRequest,
      },
      {
        name: "id",
        type: "Path",
  ...
  {
    method: "get",
    path: "/api/vendors/:id/debt/settlements",
    alias: "getApivendorsIddebtsettlements",
    requestFormat: "json",
    parameters: [
      {
        name: "id",
    ...
    response: z.array(VendorDebtHistoryResponse),
  },
  {
    method: "post",
  ...
  {
    method: "post",
    path: "/api/vendors/debt/settle-batch",
    alias: "postApivendorsdebtsettleBatch",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: z.array(SettleVendorDebtBatchItem),
      },
    ],
    response: z.void(),
  },
  {
    method: "delete",
    path: "/api/vendors/debt/settlements/:historyId",
    alias: "deleteApivendorsdebtsettlementsHistoryId",
    requestFormat: "json",
    parameters: [
      {
        name: "historyId",
